...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Grilled chicken breast with crispy bacon and smoky BBQ sauce.',
    basePrice: 9.50,
    image: 'https://images.unsplash.com/photo-1615719413546-198b25453f85?auto=format&fit=crop&w=500&q=80',
    category: 'main',
    defaultIngredientIds: ['ing-chicken', 'ing-bacon', 'ing-lettuce', 'ing-cheddar', 'ing-bbq'],
    allowedIngredientIds: Object.keys(MOCK_INGREDIENTS),
  },
  {
    id: 'prod-3',
    name: 'Truffle Fries',
    description: 'Crispy french fries tossed in truffle oil and parmesan.',
    basePrice: 4.99,
